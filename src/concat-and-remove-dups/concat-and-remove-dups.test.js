...
describe('concatAndRemoveDups', () => {
  describe('concatenation', () => {
    ...
    it('should handle empty arrays', () => {
      expect(concatAndRemoveDups([], [])).to.deep.equal([]);
      expect(concatAndRemoveDups([1, 4], [])).to.deep.equal([1, 4]);
      expect(concatAndRemoveDups([], [3, 2, 8])).to.deep.equal([3, 2, 8]);
    });
  });
  ...
  describe('dups removal', () => {
    ...
    it('should remove multiple duplicates', () => {
      expect(
        concatAndRemoveDups([1, 4, 5, 2, 8], [2, 9, 1, 8, 7])
