...
var _import = require("../../helpers/name-method");

var nameMethod = _interopRequireWildcard(_import);

var _import2 = require("../../helpers/define-map");

var defineMap = _interopRequireWildcard(_import2);

var _import3 = require("../../../messages");

var messages = _interopRequireWildcard(_import3);

var _import4 = require("../../../util");

var util = _interopRequireWildcard(_import4);
...
var _import5 = require("../../../types");

var t = _interopRequireWildcard(_import5);

var PROPERTY_COLLISION_METHOD_NAME = "__initializeProperties";

var shouldVisit = t.isClass;
...
var constructorVisitor = _traverse2["default"].explode({
  ThisExpression: {
...
var verifyConstructorVisitor = _traverse2["default"].explode({
  MethodDefinition: {
...
var ClassTransformer = (function () {
  ...
  ClassTransformer.prototype.buildBody = function buildBody() {
    ...
    for (var i = 0; i < classBody.length; i++) {
      ...
      if (node.decorators) {
        _memoiseDecorators2["default"](node.decorators, this.scope);
      }
